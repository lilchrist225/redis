...
if (isset($_POST['connecter'])) {
    ...
    $requete = "SELECT * FROM l1_miage WHERE matricule = ? 
                UNION 
                SELECT * FROM l1_gi WHERE matricule = ?";
    ...
    if ($affiche) {
        foreach ($affiche as $result) {
            ...
            $_SESSION['nom'] = $result['nom']; // Assurez-vous que cela correspond au nom de colonne
            $_SESSION['prenom'] = $result['prenom']; // Assurez-vous que cela correspond au nom de colonne
