...
foreach ($filleules as $filleule) {
    ...
    $insertionRequete = "INSERT INTO parrain_filleule_l3_l2_gi (filleule_id, filleule_nom, parrain_id, parrain_nom) VALUES (?, ?, ?, ?)";
