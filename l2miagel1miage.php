...
foreach ($filleules as $filleule) {
    ...
    $insertionRequete = "INSERT INTO parrain_filleule_l2_l1_m (filleule_id, filleule_nom, parrain_id, parrain_nom) VALUES (?, ?, ?, ?)";
